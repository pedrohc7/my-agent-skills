# Skill: Analise e Criacao de Graficos

Quando invocado com `/chart`, siga este fluxo completo de analise e visualizacao de dados.
...
- **Dash (Plotly)** — dashboards analíticos profissionais em Python
